  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <ProxyDisclosure
          warnings={[
            ...warnings,
            ...data.warnings,
            "This is a derived proxy metric. It is not an official money-printing counter or government statistic.",
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        {/* Component breakdown and sources */}
        <div>
